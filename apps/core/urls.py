...
urlpatterns = [
    ...
    path(
        "configuracoes/integracoes/correios/",
        views.correios_settings,
        name="correios_settings",
    ),
    path(
        "configuracoes/integracoes/mandae/",
        views.mandae_settings,
        name="mandae_settings",
    ),
    path(
        "configuracoes/integracoes/pagarme/",
        views.pagarme_settings,
        name="pagarme_settings",
    ),
    path(
        "configuracoes/integracoes/motoboy/",
        views.motoboy_settings,
        name="motoboy_settings",
    ),
