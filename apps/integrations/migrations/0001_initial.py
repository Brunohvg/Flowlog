...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipient_phone",
                    models.CharField(
                        help_text="Últimos 4 dígitos do telefone", max_length=20
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "created_at"], name="integration_tenant__6d3a8e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationlog",
            index=models.Index(
                ...
                name="integration_order_i_a1b2c3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="notificationlog",
            index=models.Index(
                fields=["status", "created_at"], name="integration_status__d4e5f6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationlog",
            index=models.Index(
                ...
                name="integration_notific_g7h8i9_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="integration_correla_j0k1l2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="apirequestlog",
            index=models.Index(
                fields=["instance_name", "created_at"],
                name="integration_instanc_m3n4o5_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="apirequestlog",
            index=models.Index(
                ...
                name="integration_status__p6q7r8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="apirequestlog",
            index=models.Index(
                ...
                name="integration_endpoin_s9t0u1_idx",
            ),
        ),
    ]
