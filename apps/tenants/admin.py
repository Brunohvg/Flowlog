...
class TenantSettingsAdmin(admin.ModelAdmin):
    list_display = ("tenant", "pagarme_enabled", "correios_enabled", "mandae_enabled", "whatsapp_enabled")
    list_filter = ("pagarme_enabled", "correios_enabled", "mandae_enabled", "whatsapp_enabled")
