            ...
            if len(identifier_digits) == 11:
                ...
                if customers.exists():
                    ...
                    if not valid_customer:
                        ...
                        request.session['tracking_customer_ids'] = [str(cid) for cid in customer_ids]
...
def tracking_orders(request):
    ...
    return render(request, 'tracking/orders.html', {
    ...
    if query:
        ...
        # Se tem 11 dígitos, busca por CPF
            ...
            if customers.exists():
                ...
                ).select_related('customer', 'tenant').order_by('-created_at')[:20]
